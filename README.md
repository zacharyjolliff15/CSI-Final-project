...
If your user account is not listed, add it by clicking Add…, then type your username or use Advanced… > Find Now to select your account.
...
Download and install MySQL Server Workbench.
Install SQL Server as well if required.
